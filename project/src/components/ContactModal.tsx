...
const ContactModal: React.FC = () => {
  ...
  return (
    showModal && (
      <div
        className={` border-2 flex flex-col bg-background w-[35rem] h-[32rem] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-10 pt-5 shadow-lg rounded-sm z-30`}
      >
        <motion.div
        ...
        <div className=" border-primary text-[1.7rem] text-primary">Contact Me</div>
